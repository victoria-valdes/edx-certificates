...
class CertificateGen(object):
    ...
    def _generate_v1_certificate(
        ...
        paragraph_string = "Santiago de Chile, 6 de noviembre de 2019".format(self.issued_date)
...
#            styleOpenSans.leading = 21
        ...
        #    self.course, self.long_course.decode('utf-8'))
        paragraph_string = u"<b style='line-height: 2'><i>Introducción a las teorías feministas II</i></b>".format(
            self.course, self.long_course.decode('utf-8'))
        ...
        paragraph_string = "Realizado entre el 1 de octubre y el 6 de noviembre de 2019<br/><br/>" \
