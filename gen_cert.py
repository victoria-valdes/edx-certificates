...
class CertificateGen(object):
    ...
    def _generate_v1_certificate(
        ...
        paragraph_string = "Santiago de Chile, 26 de julio de 2019".format(self.issued_date)
...
#            styleOpenSans.leading = 21
        ...
        #    self.course, self.long_course.decode('utf-8'))
        paragraph_string = u"<b style='line-height: 2'><i>Paisaje Sonoro: escucha, experiencia y cotidianidad II</i></b>".format(
            self.course, self.long_course.decode('utf-8'))
        ...
        paragraph_string = "realizado entre el 25 de junio y el 26 de julio de 2019<br/><br/>" \
