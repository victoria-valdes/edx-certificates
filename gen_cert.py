...
class CertificateGen(object):
    ...
    def _generate_v1_certificate(
        ...
        paragraph_string = "Santiago de Chile, 20 de diciembre de 2017".format(self.issued_date)
...
#            styleOpenSans.leading = 21
        ...
        #    self.course, self.long_course.decode('utf-8'))
        paragraph_string = u"<b style='line-height: 2'><i>Interculturalidad, migración y racismos</i></b>".format(
            self.course, self.long_course.decode('utf-8'))
        ...
        paragraph_string = "realizado entre el 14 de noviembre y el 19 de diciembre de 2017<br/><br/>" \
