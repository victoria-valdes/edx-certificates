...
class CertificateGen(object):
    ...
    def _generate_v1_certificate(
        ...
        paragraph_string = "Santiago de Chile, 8 de mayo de 2018".format(self.issued_date)
...
#            styleOpenSans.leading = 21
        ...
        #    self.course, self.long_course.decode('utf-8'))
        paragraph_string = u"<b style='line-height: 2'><i>Vulnerabilidades ante desastres socionaturales 4° edición</i></b>".format(
            self.course, self.long_course.decode('utf-8'))
        ...
        paragraph_string = "realizado entre el 3 de abril y el 8 de mayo de 2018<br/><br/>" \
