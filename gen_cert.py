...
class CertificateGen(object):
    ...
    def _generate_v1_certificate(
        ...
        paragraph_string = "Santiago de Chile, 15 de octubre de 2019".format(self.issued_date)
...
#            styleOpenSans.leading = 21
        ...
        #    self.course, self.long_course.decode('utf-8'))
        paragraph_string = u"<b style='line-height: 2'><i>Cómo envejecemos: una mirada transdisciplinaria III</i></b>".format(
            self.course, self.long_course.decode('utf-8'))
        ...
        paragraph_string = "Realizado entre el 10 de septiembre y el 15 de octubre de 2019<br/><br/>" \
